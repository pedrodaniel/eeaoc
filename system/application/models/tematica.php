...
class Tematica extends Model
{
	...
	{
		 $sql = "select t.id, t.nombre, t.imagen, t.padre_id, t.fecha_carga, u.apellido as usuario_apellido, u.nombre as usuario_nombre,
	...
	{
		$sql = "select id, nombre, imagen, padre_id, descripcion from tematica where id = ".$tematica_id;
		$query = $this->db->query($sql);
		if ($query->num_rows() > 0)
		{
			$res = $query->result_array();
