...
<br/>
	<div class="content">
		...
		<div style="width:100%; float:left">
			<img src="<?=site_url("upload/proyecto/".$imagen['proyectos_id']."/".$imagen['img'])?>" style="float: left; margin-right: 10px;" id="thumbnail" alt="Create Thumbnail" />
		</div>
		<br/><br/>
		...
		<form>
		<input name="id" id="id" type="hidden" value="<?=$imagen['proyectos_id']?>"/>
