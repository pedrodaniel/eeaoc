...
<form id="page_img_form" method="post" enctype="multipart/form-data" action="<?=site_url("admin/proyectos/CreaImg")?>">
			...
			<tr>
				...
				<td>	<input type="text" name="link" id="link" value="<?=(isset($proyecto['link']))?$proyecto['link']:""?>" style="width: 70%;" />
				</td>
	  		</tr>
	  			<tr>
	  			<td>	Navegador:
